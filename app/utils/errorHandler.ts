...
const messageToKeyMap: Record<string, string> = {
  ...
  'Kullanıcı Yetkileri Eklendi': 'errors.backendUserOperationClaimsAdded',
  ...
  'Serbest Berber': 'errors.backendFreeBarberDefaultName',
  ...
  'Deneme süresinde en fazla 2 dükkan ekleyebilirsiniz. Daha fazlası için lütfen abone olunuz.': 'errors.backendTrialPanelLimitReached',
