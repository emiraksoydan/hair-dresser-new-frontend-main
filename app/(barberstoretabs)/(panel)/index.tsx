...
import { useBarberStorePanelEarningsPreview } from "../../hook/usePanelEarningsPreview";
...
const Index = () => {
  ...
  const panelEarningsPreview = useBarberStorePanelEarningsPreview(storeIds);
        ...
        >
          ...
          {stores.length > 0 && (
            <TouchableOpacity
              ...
              style={{ backgroundColor: isDark ? "rgba(37,99,235,0.25)" : "rgba(37,99,235,0.12)", borderColor: "#3b82f6", borderWidth: 1 }}
            >
              <View className="flex-row items-center justify-between">
                <View className="flex-1 pr-2">
                  ...
                  <Text style={{ color: colors.textSecondary, fontSize: 11, marginTop: 2 }}>
                    {t("profile.storeEarningsSubtitle")}
                  </Text>
                  {panelEarningsPreview != null && (
                    <View style={{ marginTop: 8, gap: 8 }}>
                      <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                        <Text style={{ color: colors.textSecondary, fontSize: 11 }}>{t("profile.dailyEarnings")}</Text>
                        <AnimatedMoneyText
                          value={panelEarningsPreview.dailyEarnings ?? 0}
                          suffix={PANEL_CURRENCY}
                          style={{ color: "#0d9488", fontFamily: "CenturyGothic-Bold", fontSize: 14 }}
                          enabled={priceAnim}
                        />
                      </View>
                      <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}>
                ...
                <IconButton icon="chart-line" iconColor="#ffb900" size={24} />
              </View>
            </TouchableOpacity>
          )}
        </PanelCollapsibleTop>
